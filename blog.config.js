...
const BLOG = {
  ...
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'http://t.cn/Aiu9LI6u', // 你的微博个人主页
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'wechat,qq,weibo', // 分享的服務，按顺序显示,逗号隔开
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-preiview-p3th7kn8j-0923zzz.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
